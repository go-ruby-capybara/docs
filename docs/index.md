# go-ruby-capybara documentation

**Pure-Go Capybara: acceptance-test DSL over a rack-test driver (CSS/XPath), CGO=0 — bound into rbgo**

`go-ruby-capybara/capybara` is a faithful, pure-Go (zero cgo) reimplementation of Ruby's `capybara`,
...
!!! success "Status: pure-Go, CGO=0, differential-tested"
    A faithful pure-Go port of Ruby's `capybara`, validated against reference Ruby, at 100%
...
| Repo | What it is |
| --- | --- |
| [`capybara`](https://github.com/go-ruby-capybara/capybara) | the library — Ruby's `capybara` in pure Go |
| [`docs`](https://github.com/go-ruby-capybara/docs) | this documentation site (MkDocs Material, versioned with mike) |
| [`go-ruby-capybara.github.io`](https://github.com/go-ruby-capybara/go-ruby-capybara.github.io) | the organization landing page (Hugo) |
| [`brand`](https://github.com/go-ruby-capybara/brand) | logo and brand assets |
...
Source lives at [github.com/go-ruby-capybara/capybara](https://github.com/go-ruby-capybara/capybara).
