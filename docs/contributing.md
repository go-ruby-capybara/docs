...
Contributions are welcome. `go-ruby-capybara/capybara` is built to a small set of
...
The library is in [`github.com/go-ruby-capybara/capybara`](https://github.com/go-ruby-capybara/capybara).
This documentation site is in [`github.com/go-ruby-capybara/docs`](https://github.com/go-ruby-capybara/docs).
