...
The public API lives at the module root (`github.com/go-ruby-capybara/capybara`). It is
**Ruby-shaped but Go-idiomatic**: names mirror Ruby's `capybara`, while the surface follows
...
```go
import "github.com/go-ruby-capybara/capybara"
```
...
- **[pkg.go.dev/github.com/go-ruby-capybara/capybara](https://pkg.go.dev/github.com/go-ruby-capybara/capybara)**

The module's [README](https://github.com/go-ruby-capybara/capybara#readme) carries worked
